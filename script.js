...
document.getElementById("openBtn").addEventListener("click", function () {
    ...
    document.getElementById("greeting").style.display = "none"; // sembunyikan judul
    document.getElementById("heart").style.display = "block"; // Tampilkan canvas
    bgMusic.play();
    init(); // Mulai animasi
    setTimeout(function () {
        window.location.href = "card.html";
    }, 11000); // 7000 ms = 7 detik
});
